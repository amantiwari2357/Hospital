            ...
            <div className="w-full max-w-md">
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900">HMS Enterprise</h1>
                        <p className="text-sm text-blue-600 font-medium mt-1">SUPER ADMIN PORTAL</p>
                        <p className="text-sm text-gray-500 mt-3">Please sign in to access the dashboard</p>
                    </div>
